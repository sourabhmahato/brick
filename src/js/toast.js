/**
 * brick - Toast Notifications
 *
 * Usage:
 *   bk.toast('Saved!')
 *   bk.toast('Action completed successfully', 'All good')
 *   bk.toast('Operation completed.', 'Success', { variant: 'success' })
 *   bk.toast('Something went wrong.', 'Error', { variant: 'danger', placement: 'bottom-center' })
 *
 *   // Custom markup
 *   bk.toast.el(element)
 *   bk.toast.el(element, { duration: 4000, placement: 'bottom-center' })
 *   bk.toast.el(document.querySelector('#my-template'))
 */
